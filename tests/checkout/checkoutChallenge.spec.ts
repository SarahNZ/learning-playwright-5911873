// This test file is commented out as it was provided by the Playwright LinkedIn course tutor, but is failing.
// I'm just keeping it in the repo if I want to reference the test steps and assertions in the future
